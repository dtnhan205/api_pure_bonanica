        ...
        attachments: [
            {
                ...
                path: 'http://localhost:10000/images/logo_email_register.png', // URL của logo
                cid: 'logo_purebotanica', // Tham chiếu trong HTML
            },
            // Nhúng thêm hình ảnh mạng xã hội nếu cần
        ],
    };
