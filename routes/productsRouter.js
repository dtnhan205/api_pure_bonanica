...
router.put('/:slug',authMiddleware, isAdmin, optionalUpload, handleMulterError, productController.updateProduct);
router.delete('/:slug',authMiddleware, isAdmin, productController.deleteProduct);
router.put('/:slug/toggle-visibility',authMiddleware, isAdmin, productController.toggleProductVisibility);
